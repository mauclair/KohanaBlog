...
<form action="" method="post">
				<table class="login">
					...
					<tr>
						<td>Эл. почта:</td>
						<td><input type="text" name="email" id="email"><span id="trueimg" style="display:none"><img src="/img/ok.png"></span><span id="falseimg" style="display:none"><img src="/img/error.png"></span></td>
					</tr>
